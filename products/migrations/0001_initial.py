# Generated by Django 4.2 on 2024-04-23 16:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='create time')),
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='update')),
                ('prodcut', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.product', verbose_name='products')),
            ],
            options={
                'verbose_name': 'file',
